...
exports.processTarotDraw = async function(event, userId, userData, userRef, db, client, genAI, FieldValue, recordDivinationLog) {
    ...
    (async () => {
        ...
        try {
            ...
            const tarotConfig = configDoc.exists && configDoc.data().tarot ? configDoc.data().tarot : { model: "gemini-3.1-pro-preview", cost: 10 };
